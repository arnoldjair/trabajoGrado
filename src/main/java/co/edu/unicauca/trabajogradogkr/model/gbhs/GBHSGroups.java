...
public class GBHSGroups implements GBHS {
    ...
    @Override
    public Agent process(int hms, int maxImprovisations, int maxK, int maxKMeans, double minPar, double maxPar, double hmcr, double pOptimize, Dataset dataset, ObjectiveFunction f, boolean log, Random random, Distance distance) {
